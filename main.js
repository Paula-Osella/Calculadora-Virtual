...
//     return fetch('https://jsonplaceholder.typicode.com/posts', { // URL ficticia de ejemplo
//         method: 'POST',
//         headers: {
...
//     };
//     localStorage.setItem('usuario', JSON.stringify(usuarioParaGuardar));
//     enviarDatosAlServidor(usuarioParaGuardar).then(data => {
...
// document.getElementById('buscarGasto').addEventListener('keydown', event => {
//     if (event.key === "Enter") {
//         buscar();
//     }
// });
