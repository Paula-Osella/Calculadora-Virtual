...
let gananciaDelmes = parseInt(prompt("Ingrese cuánto gana en el mes"));
let semanasDelmes = parseInt(prompt("Ingrese cuántas semanas tendrá este mes"));
...
function calcularPromedio(gananciaDelmes, gastosDelmes, semanasDelmes) {
    if (gananciaDelmes > gastosDelmes) {
        ...
        alert("En base a tus gastos, terminarías ahorrando" + " " + "$" + promedio + " " + "por semana");
    } else {
